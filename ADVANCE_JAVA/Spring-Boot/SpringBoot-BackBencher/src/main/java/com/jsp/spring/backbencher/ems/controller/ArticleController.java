...
public class ArticleController {
    ...
    public String listArticles(Model model) {
        ...
        return "articles/list"; // Create articles/list.html
    }
    ...
    public String getArticle(@PathVariable Long id, Model model) {
        ...
        return "articles/detail"; // Create articles/detail.html
    }
    ...
    public String showAddForm(Model model) {
        ...
        return "articles/add"; // Create articles/add.html
    }

    @PostMapping("/add")
    public String addArticle(@ModelAttribute Article article, @RequestParam Long courseId, Principal principal) {
        // Set author and course
        User user = userService.findByEmail(principal.getName()).orElseThrow(() -> new IllegalArgumentException("User not found"));
        Course course = courseService.getCourseById(courseId).orElseThrow(() -> new IllegalArgumentException("Course not found"));
    ...
    public String showEditForm(@PathVariable Long id, Model model) {
        ...
        model.addAttribute("article", article);
        model.addAttribute("courses", courseService.getAllCourses());
        return "articles/edit"; // Create articles/edit.html
    }
    ...
    public String searchArticles(@RequestParam String query, Model model) {
        ...
        return "articles/search"; // Create articles/search.html
    }
}